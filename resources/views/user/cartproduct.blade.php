...
<div class="card">
    <div class="row">
        <div class="col-md-8 cart">
            <div class="title">
                <div class="row">
                    ...
                    <div class="col align-self-center text-right text-muted">items {{$cartItems->totalQuatity}}</div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="row main align-items-center">
                    ...
                    <div class="col">${{$item['totalSinglePrice']}} <a href="{{route('deleteItemFromCart',["id"=>$item['data']['id']])}}" class="close">delete</a></div>
                </div>
            </div>
            @endforeach
            
          
            <div class="back-to-shop"><a href="{{Route('user.dashboard')}}">&leftarrow;</a><span class="text-muted">Back to shop</span></div>
        </div>
        <div class="col-md-4 summary">
            ...
            <hr>
            <div class="row">
                <div class="col" style="padding-left:0;">ITEMS {{$cartItems->totalQuatity}}</div>
