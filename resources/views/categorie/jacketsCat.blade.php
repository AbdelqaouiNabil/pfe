                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                                <div class="single-new-arrival mb-50 text-center">
                                    <div class="popular-img">
                                        <img src="{{Storage::disk('local')->url('products_images/'.$jacket->image)}}" alt="">
                                      
                                    </div>
                                    <div class="popular-caption">
                                     <h3><a href="product_details.html">{{$jacket->name}}</a></h3>
                                  
                                    <span>{{$jacket->price}}</span>
                                    <div class="room-btn mt-20">
                                        <a href="{{route('addToCartProduct',['id'=>$jacket->id])}}" class="border-btn">Add To Cart</a>
                                    </div>
                                </div>
                            </div>
                        </div>
